/*  Checks if the civilian is far away enough from all players to get deleted
/*
/*  Param0: Civilian
/*  Param1: Car
*/
...
if ((_car distance _civ) <= 20) then {	// Delete the car if it's close to the civilian (and therefore far away from any player, too...)
	...
	[_car] spawn L_fnc_civs_carCheck;	// ... and run a separate routine on the car if it's not close to the civilian
};
